<form action={kurl action="container"} method="POST">
	...
	<div class="photos_addcontainer_tags" id="Photos_add_tags">
	...
	<div class="photos_addcontainer_submit">

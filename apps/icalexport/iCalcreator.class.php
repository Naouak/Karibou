...
define( 'ICALCREATOR_VERSION', 'iCalcreator 2.4' );
/*********************************************************************************/
/*********************************************************************************/
/**
 * vcalendar class
        ...
        if( 0 < count( $recurlist )) {
          ...
          foreach( $recurlist as $recurkey => $durvalue ) {
            ...
            if( $startWdate >= $recurkey ) // exclude component start date
              continue;
            $rstart = $component->_date_time_string( date('Y-m-d H:i:s', $recurkey ), 6);
            $rend   = $component->_date_time_string( date('Y-m-d H:i:s', ( $recurkey + $durvalue )), 6);
            $rend   = $component->_date2timestamp( $rend );
            $rstart = $recurkey;

...
<style type="text/css">
	...
	.frenchflag{
		background-image: url(/website/themes/karibou/images/preferences/flags/fr.png);
	}
	
	.englishflag{
		background-image: url(/website/themes/karibou/images/preferences/flags/uk.png);
	}

	...
	{
	?>
		<a id="account_flashmail_read_link" href="<?=kurl(array('app'=>"flashmail", 'page'=>"unreadlist"));?>" onclick="Effect.toggle('flashmail_headerbox_unreadlist'); return false;"><?=count($this->vars['flashmails']);?>
		<?

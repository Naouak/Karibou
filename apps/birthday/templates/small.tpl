...
<span>{userlink user=$bdayer.user showpicture=$islogged} / {userlink user=$bdayer.user showpicture=$islogged showfullname=true}, {t count=$bdayer.age 1=$bdayer.age plural="%1 years old"}%1 year old{/t}</span>
{if ($islogged)}
{if (!$noflashmail)}

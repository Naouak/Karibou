...
{/if}
	...
	<label for="startdate">##STARTDATE##</label>
		{html_select_date day_extra='class="input_xs"' month_extra='class="input_m"' year_extra='class="input_s"' prefix="startdate" start_year="-1" end_year="+3" field_order="DMY" time=$event->startdate}{*time="YYYY-MM-DD"*}

...
{/if}
	...
	<label for="startdate">##STARTDATE##</label>
		{html_select_date all_extra='onchange="javascript:ctrl_dates_start();"' day_extra='class="input_xs"' month_extra='class="input_m"' year_extra='class="input_s"' prefix="startdate" start_year="-1" end_year="+3" field_order="DMY" time=$startdate}{*time="YYYY-MM-DD"*}
		<span class="text">##AT##</span>
		{html_select_time all_extra='onchange="javascript:ctrl_dates_start();"' hour_extra='class="input_xs"' minute_extra='class="input_xs"' prefix="startdate" use_24_hours=true minute_interval=15 display_seconds=false time=$startdate}
	<br class="spacer" />
	<label for="enddate">##ENDDATE## {$stopdate}</label>
		{html_select_date day_extra='class="input_xs"' month_extra='class="input_m"' year_extra='class="input_s"' prefix="enddate" start_year="-1" end_year="+3" field_order="DMY" time=$stopdate}
		<span class="text">##AT##</span>
		{html_select_time hour_extra='class="input_xs"' minute_extra='class="input_xs"' prefix="enddate" use_24_hours=true minute_interval=15 display_seconds=false time=$stopdate}
{*
	<br class="spacer" />
